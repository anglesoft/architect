...
When I heard Abed say at Laracon EU ["No more legacy code"](https://www.youtube.com/watch?v=wSnM4JkyxPw), I was totally seduced by that idea. But when I dived into the [Lucid Architecture](https://github.com/lucid-architecture), it didn't quite fit my routine: I had to move too many files here and there and tear off too many roots from my code base in order to adopt it. My main concern was to keep the Laravel folders in place as I love how the framework is organized. So I built Architect, which simply adds App\Features and App\Tasks folders in your app/ directory.
